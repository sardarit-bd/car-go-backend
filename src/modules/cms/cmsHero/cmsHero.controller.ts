...
import * as cmsHeroService from "./cmsHero.service.js";
import sendResponse from "../../../shared/utils/response.js";

export const createCmsHero = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
  try {
    ...
    return sendResponse(
      ...
      201,
      true,
      "Hero section created/updated successfully",
      hero,
    );
  } catch (error) {
    next(error);
...
export const getCmsHeroById = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
...
export const updateCmsHero = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
...
export const deleteCmsHero = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
