...
export const createCmsHero = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const getCmsHero = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const getCmsHeroById = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const updateCmsHero = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const deleteCmsHero = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
