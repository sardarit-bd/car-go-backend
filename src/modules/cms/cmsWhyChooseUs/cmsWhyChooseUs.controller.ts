...
export const createCmsWhyChooseUs = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const getCmsWhyChooseUs = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const getCmsWhyChooseUsById = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const updateCmsWhyChooseUs = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const deleteCmsWhyChooseUs = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
