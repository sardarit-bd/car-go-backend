...
export const createCmsWhyChooseUsFeature = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const getAllCmsWhyChooseUsFeatures = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const getCmsWhyChooseUsFeatureById = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const updateCmsWhyChooseUsFeature = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const deleteCmsWhyChooseUsFeature = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
