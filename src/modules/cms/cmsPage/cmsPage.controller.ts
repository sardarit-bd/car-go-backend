...
export const getAllCmsPages = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const getCmsPageById = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const getCmsPageByType = async (req: Request, res: Response, next: NextFunction) => {
  try {
