...
export const createCmsHeroFeature = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const getAllCmsHeroFeatures = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const getCmsHeroFeatureById = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const updateCmsHeroFeature = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const deleteCmsHeroFeature = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
