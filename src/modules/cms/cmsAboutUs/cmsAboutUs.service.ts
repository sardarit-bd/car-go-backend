import {
  findCmsAboutUs,
  findCmsAboutUsById,
  createOrUpdateCmsAboutUs,
  softDeleteCmsAboutUs,
} from "./cmsAboutUs.repository.js";
...
export const createOrUpdateCmsAboutUsService = async (data: any) => {
  return await createOrUpdateCmsAboutUs(data);
};

export const deleteCmsAboutUsService = async (id: string) => {
