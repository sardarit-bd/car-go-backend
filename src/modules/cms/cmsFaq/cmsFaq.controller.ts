...
export const createCmsFaq = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const getAllCmsFaqs = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const getCmsFaqById = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const updateCmsFaq = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const deleteCmsFaq = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
